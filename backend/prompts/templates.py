...
4. "is_unlisted_topic": boolean. True if the user is asking about a specific project, skill, internship, or experience that Pavan has NOT done or listed (refer to the list of Pavan's actual work below). False if the user is asking about things Pavan has actually built/done, general info, or soft personal/personality questions (e.g. habits, weaknesses, flaws, hobbies, interests).
...
6. "response_length": string. Either "short" (for quick greetings, direct single-field queries like email/phone, or simple single-word lookups) or "detailed" (for any queries asking about projects, skills, experience, internships, or what Pavan built, since these require a detailed explanation of accomplishments, metrics, and tech stacks).
